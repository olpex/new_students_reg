document.addEventListener('DOMContentLoaded', () => {
    ...
    // Sample groups for GitHub Pages demo
    const sampleGroups = [
        { name: "Група 101" },
        { name: "Група 102" },
        { name: "Група 103" },
    ...
    // Form submission for GitHub Pages demo
    registrationForm.addEventListener('submit', async (e) => {
        ...
        // For GitHub Pages demo, just show success message
        console.log('Form data:', formData);
        showMessage('Дані успішно відправлено! (Демо-версія для GitHub Pages)', 'success');
        registrationForm.reset();
        // Reset phone input with +380 prefix after form reset
        phoneInput.value = '+380';
    });

    // Load sample groups for GitHub Pages demo
